...
export function Header({
  ...
  return (
    <header className="min-w-fit shadow min-h-fit md:min-h-0 h-20    sticky top-0 z-50 w-full font-quicksand bg-white flex gap-8 justify-between px-12 items-center py-1">
      <Link
