...
export const useManageMarketplace = () => {
  ...
  const handleOpenEditModal = (souvenirPlace: SouvenirPlaceSchema) => {
    ...
    setInitialValues((prev) => ({
      ...
      country: souvenirPlace.location?.country.toLowerCase(),
      province: souvenirPlace.location?.province.toLowerCase(),
      regency: souvenirPlace.location?.regency.toLowerCase(),
      district: souvenirPlace.location?.district.toLowerCase(),
      village: souvenirPlace.location?.village.toLowerCase(),
      postal_code: souvenirPlace.location?.postal_code,
      street: souvenirPlace.street || "",
